...
#                ('submission_id', models.ForeignKey(blank=True, db_column='submission_id', on_delete=django.db.models.deletion.DO_NOTHING, serialize=False,null=True, to='dynadb.DyndbSubmission')),
                ...
                ('id_model',models.ForeignKey(blank=True, db_column='id_model', on_delete=models.CASCADE, null=True, to='dynadb.DyndbModel')),
            ],
            options={
                'managed': False,
...
#               ('type', models.TextField(blank=True, null=True)),
                ('type', models.SmallIntegerField(choices=[(0,'Input coordinates'),(1,'input topology'),(2,'trajectory'),(3,'others')], null=True, default=0)),
            ],
            options={
                'managed': True,
