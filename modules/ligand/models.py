...
from modules.common.models import WebLink
from modules.common.tools import fetch_from_web_api
...
class Ligand(models.Model):
    ...
    ambigious_alias = models.BooleanField(null=True) #required to flag 'safe' alias, eg one parent
