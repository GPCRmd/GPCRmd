...
from modules.protein.models import Protein, ProteinConformation, ProteinFamily, Species, ProteinSource, ProteinSegment
from modules.residue.models import Residue, ResidueNumberingScheme, ResidueGenericNumber
