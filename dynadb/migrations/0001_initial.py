    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.IntegerField(blank=True, null=True)),
                ('last_update_by', models.IntegerField(blank=True, null=True)),
                ('submission_id', models.IntegerField(blank=True, null=True, unique=True)),
            ],
            options={
                'managed': False,
        ...
        migrations.CreateModel(
            name='JuanmaappFormup',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uniprotid', models.CharField(db_column='UNIPROTid', max_length=20)),
                ('iso', models.CharField(max_length=100)),
                ('mut', models.CharField(db_column='MUT', max_length=4)),
                ('nam', models.CharField(db_column='Nam', max_length=30)),
                ('organ', models.CharField(db_column='ORGAN', max_length=200)),
                ('descmol', models.TextField(db_column='DescMOL')),
                ('netc', models.IntegerField(db_column='NETc')),
                ('inchi', models.TextField(db_column='INCHI')),
                ('inchik', models.CharField(max_length=27)),
                ('smi', models.TextField(db_column='SMI')),
                ('resnammol', models.CharField(db_column='resnamMOL', max_length=5)),
                ('nummol', models.IntegerField(db_column='numMOL')),
                ('mainprot', models.TextField(db_column='MAINprot')),
                ('mainlig', models.TextField(db_column='MAINlig')),
                ('ionresn', models.CharField(db_column='IONresn', max_length=5)),
                ('ionnum', models.IntegerField(db_column='IONnum')),
                ('comtyp', models.CharField(db_column='COMtyp', max_length=50)),
                ('idprot', models.CharField(db_column='idproT', max_length=50)),
                ('idcom', models.CharField(db_column='idcoM', max_length=50)),
                ('msour', models.CharField(db_column='Msour', max_length=50)),
                ('pdb', models.CharField(db_column='PDB', max_length=4)),
                ('desc', models.TextField()),
                ('mtemp', models.TextField(db_column='mTEMP')),
                ('meth', models.CharField(db_column='METH', max_length=50)),
                ('soft', models.CharField(db_column='SOFT', max_length=50)),
                ('softver', models.CharField(db_column='SOFTver', max_length=50)),
                ('ffield', models.CharField(max_length=50)),
                ('memb', models.CharField(db_column='MEMB', max_length=50)),
                ('solv', models.CharField(db_column='Solv', max_length=50)),
                ('pdbcoor', models.CharField(db_column='PDBcoor', max_length=50)),
                ('psf', models.CharField(db_column='PSF', max_length=50)),
                ('toppsf', models.CharField(db_column='topPSF', max_length=50)),
                ('par', models.CharField(max_length=50)),
                ('dcd', models.CharField(db_column='DCD', max_length=50)),
            ],
            options={
                'managed': False,
