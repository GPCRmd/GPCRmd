...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        dynamics_path = "/protwis/sites/files/Dynamics"
        pickle_path = "/protwis/sites/files/Precomputed/WaterMaps"
        ...
        #{'pdb_path': '/protwis/sites/files/Dynamics/10177_dyn_9.pdb', 'dyn_id': 9, 'file_id': 10177} which is a dictionary 
