...
#    url(r'^admin/', admin.site.urls),
    ...
    url(r'^moleculereuse/(?P<submission_id>[0-9]+)/(?P<model_id>[0-9]+)/generate_properties/$', views.generate_molecule_properties, name='generate_molecule_properties_reuse'),
    url(r'^moleculereuse/(?P<submission_id>[0-9]+)/(?P<model_id>[0-9]+)/delete/$', views.delete_molecule, name='delete_molecule_reuse'),
    url(r'^moleculereuse/(?P<submission_id>[0-9]+)/(?P<model_id>[0-9]+)/get_compound_info_pubchem/$', views.get_compound_info_pubchem, name='get_compound_info_pubchem_reuse'),
    url(r'^moleculereuse/(?P<submission_id>[0-9]+)/(?P<model_id>[0-9]+)/get_compound_info_chembl/$', views.get_compound_info_chembl, name='get_compound_info_chembl_reuse'),
    url(r'^moleculereuse/(?P<submission_id>[0-9]+)/(?P<model_id>[0-9]+)/submitpost/$', views.submitpost_view, name='submitpost_reuse'),
    url(r'^moleculereuse/(?P<submission_id>[0-9]+)/open_pubchem/$', views.open_pubchem, name='molecule_open_pubchem_reuse'),
    url(r'^moleculereuse/(?P<submission_id>[0-9]+)/open_chembl/$', views.open_chembl, name='molecule_open_chembl_reuse'),
