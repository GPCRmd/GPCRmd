...
class Interaction(models.Model):
	...
	simulation = models.ForeignKey(Simulation, related_name='membership')
	positions = models.ForeignKey(Positions, related_name='membership')
	itype = models.ForeignKey(Itype, related_name='membership')
