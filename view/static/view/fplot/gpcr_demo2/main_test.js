...
//var clustering = 'LigandPocket: "2.2x51 2.2x53 2.2x56 2.2x57 2.2x60 2.2x61 2.2x63 2.2x64 2.2x65 3.3x28 3.3x29 3.3x32 3.3x33 3.3x36 3.3x37 3.3x40" GproteinPocket: "3.3x50 3.3x53 3.3x54 3.3x55 5.5x61 5.5x64 6.6x33 6.6x36 6.6x37"'

var clustering = 'LigandPocket: "2.2x51 2.2x53 2.2x56 2.2x57 2.2x60 2.2x61 2.2x63 2.2x64 2.2x65 3.3x28 3.3x29 3.3x32 3.3x33 3.3x36 3.3x37 3.3x40 4.4x56 4.4x57 4.4x59 4.4x60 4.4x61 5.5x38 5.5x39 5.5x42 5.5x43 5.5x44 5.5x45 5.5x46 5.5x461 5.5x47 6.6x44 6.6x45 6.6x48 6.6x51 6.6x52 6.6x54 6.6x55 6.6x58 6.6x59 7.7x30 7.7x31 7.7x32 7.7x33 7.7x34 7.7x35 7.7x36 7.7x37 7.7x38 7.7x39 7.7x40 7.7x41 7.7x42 7.7x43 7.7x44" GproteinPocket: "3.3x50 3.3x53 3.3x54 3.3x55 5.5x61 5.5x64 6.6x33 6.6x36 6.6x37"'//[!] Change this to list of important residues for some reason. Maintain the cluster names or change them in the code below!! //[!]Hardcoded

//var clustering = 'LigandPocket: "2x51 2x53 2x56 2x57 2x60 2x61 2x63 2x64 2x65 3x28 3x29 3x32 3x33 3x36 3x37 3x40 4x56 4x57 4x59 4x60 4x61 5x38 5x39 5x42 5x43 5x44 5x45 5x46 5x461 5x47 6x44 6x45 6x48 6x51 6x52 6x54 6x55 6x58 6x59 7x30 7x31 7x32 7x33 7x34 7x35 7x36 7x37 7x38 7x39 7x40 7x41 7x42 7x43 7x44" GproteinPocket: "3x50 3x53 3x54 3x55 5x61 5x64 6x33 6x36 6x37"'
...
function create_bundle(rawText) {
    ...
    var cluster = d3.layout.cluster()
        ...
        .sort(function(a, b) {
            ...
            return d3.ascending(aRes.toString(), bRes.toString());
        });
    ...
    function assignCluster(clusterDefinition, graph) {
        ...
        keys.forEach(function(clusterKey){
            ...
            console.log(nodesMap[clusterKey])
...
function transitionToSummary(){
    ...
    var legendMaxHeight = 10;//[!] Change summary links width
